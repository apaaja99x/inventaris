            ...
            <div class="p-5">
              ...
              <form action="{{ route('register') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" placeholder="Full Name" name="fullname" value="{{ old('fullname') }}" required="">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" placeholder="Username" name="username" value="{{ old('usernmae') }}" required="">
