		...
		<div class="card-body">
			<div class="row">
				<div class="col-3">
					...
					<label class="form-label plus">Atas Nama</label><br>
				</div>
				<div class="col-6">
					<form action="{{ route('borrow.store') }}" method="POST" class="user">
						...
						<div class="form-group">
							<input type="date" class="form-control form-control-user" name="tgl_pinjam" required="" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}" required @if(Auth::user()->level == 'peminjam') readonly @endif></input>
						</div>
						<div class="form-group">
							<input type="date" class="form-control form-control-user" name="tgl_kembali" required="" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->addDays(7)->toDateString())) }}" required @if(Auth::user()->level == 'peminjam') readonly @endif></input>
						</div>
						<div class="form-group">
