 ...
 <table id="pseudo-demo">
                      ...
                      <tbody>
                       <tr>
                          ...
                          <td>
                           {{date('d/m/y', strtotime($data->peminjaman->tgl_pinjam))}}
                          </td>
                          <td>
                            {{date('d/m/y', strtotime($data->peminjaman->tgl_kembali))}}
                          </td>
                          <td>
                          @if($data->peminjaman->status_peminjaman == 'Pinjam')
                            <label class="badge badge-warning">Pinjam</label>
                          @else
                            <label class="badge badge-success">Kembali</label>
                          @endif
                          </td>
                          <td>{{$data->peminjaman->users->nama_petugas}}</td>
                        </tr>
                      </tbody>
                    </table>
</body>
